...
public class EmployeeAccessEligibilityTest {
    ...
    public void testUnauthorizedDepartment() {
        ...
        assertTrue(
            result.contains("Department is not authorized")
        );
    }
    ...
    public void testInactiveEmployee() {
        ...
        assertTrue(
            result.contains("Employment status is not active")
        );
    }
    ...
    public void testInvalidEmployeeId() {
        ...
        assertTrue(
            result.contains("Employee ID is invalid")
        );
    }
    ...
    public void testMultipleFailures() {
        ...
        assertTrue(
            result.contains("Employee must be at least 21")
        );
        ...
        assertTrue(
            result.contains("Security clearance is insufficient")
        );
    }
}
