...
public class EmployeeAccessEligibility {
    ...
    static class Employee {
        ...
        Employee(String employeeId, String name, int age,
                 String department, String employmentStatus,
    ...
    public static String checkEligibility(Employee employee,
        ...
        // Employment status
        if (!employee.employmentStatus.equalsIgnoreCase("Active")) {
        ...
        // Security clearance for confidential access
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            for (int i = 0; i < n; i++) {
                ...
                String result =
                    checkEligibility(employee, requestedAccess);
